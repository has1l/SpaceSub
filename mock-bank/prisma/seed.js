...
async function main() {
    ...
    // Recurring Payments
    const subscriptions = [
        { id: 'seed-rp-yandex',  merchant: 'Yandex',  amount: -199, desc: 'Яндекс Плюс',   periodDays: 30, cat: client_1.TransactionCategory.SUBSCRIPTIONS },
        { id: 'seed-rp-spotify', merchant: 'Spotify', amount: -549, desc: 'Spotify Premium', periodDays: 30, cat: client_1.TransactionCategory.SUBSCRIPTIONS },
        { id: 'seed-rp-netflix', merchant: 'Netflix', amount: -890, desc: 'Netflix',         periodDays: 30, cat: client_1.TransactionCategory.SUBSCRIPTIONS },
        { id: 'seed-rp-icloud',  merchant: 'Apple',   amount: -299, desc: 'iCloud+ 50GB',   periodDays: 30, cat: client_1.TransactionCategory.DIGITAL_SERVICES },
    ];
    ...
    for (const sub of subscriptions) {
        ...
        for (let m = 0; m < monthsBack; m++) {
            const dayOffset = m * sub.periodDays + (rpCreated * 2);
